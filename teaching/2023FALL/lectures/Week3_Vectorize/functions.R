...
#' - good calls
## -----------------------------------------------------------------------------
mean(1:10); mean(1:10, na.rm = TRUE)
...
## -----------------------------------------------------------------------------
function(x=4) x^2 + 1
formals(function(x=4) x^2 + 1)
body(function(x=4) x^2 + 1)
environment(function(x=4) x^2 + 1)
...
#' 
#' 
#' User-defined function will be in the global environment,
#' which will mask the function (of the same name) in the other loaded packages.
#' 
## -----------------------------------------------------------------------------
plot <- function(x) print(x)
plot(1)
environment(plot)
