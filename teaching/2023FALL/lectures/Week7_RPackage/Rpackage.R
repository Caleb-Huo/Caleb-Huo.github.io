...
#' Install R packages
#' ===
#' - from CRAN, 19,930 packages, up to 9/27/2023.
## ---- eval = F---------------------------------------------------------------------------------------
## install.packages("pwr")

#' - from Bioconductor: 2,230 packages, 4/26/2023.
## ---- eval=F-----------------------------------------------------------------------------------------
...
#' - .gz.tar zipped file.
## ---- eval=F-----------------------------------------------------------------------------------------
## install.packages("pwr_1.3-0.tar",repos=NULL,type="source")

#' - package folder.
## ---- eval=F-----------------------------------------------------------------------------------------
## # in R:
## system("R CMD INSTALL pwr")
...
#' - check out vignettes: the vignette is a tutorial on how to use the package
## ---- eval=F-----------------------------------------------------------------------------------------
