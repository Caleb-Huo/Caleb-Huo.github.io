...
#' 
#' - In this example, a straight line (x=y) for QQ-plot shows the sampling distribution is likely to be $N(0,1)$).
#' 
#' 
#' 
#' QQ-plot 2
...
#' 
#' - A straight line for QQ-plot shows the sampling distribution is likely to be normally distributed.
...
#' ===
#' 
#' - With many predictors, what combination of predictors provide the best model?
#'   - AIC, BIC criteria
...
#' ===
#' 
#' - Non-parametric approach to fit the curve (usually dimension $d=1$).
#' - The basis functions are splines.
