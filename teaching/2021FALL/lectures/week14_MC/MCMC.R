...
#' ===
#' 
#' What will affect the estimation accuracy?
#' - sample size $n$
#' - others?
#' 
...
#' 
#' 
#' ![Comparison between importance sampling and Metropolis-Hastings](../figure/compareMHandDS.png)
#' 
#' 
#' 
#' 
...
#'     3. <span style="color:red">If we didn't accept $x$, set $x^t = x^{t - 1}$</span>
...
#' - If the transition kernel is $T(x'|x)$ satisfies the detailed balance condition,
#' the sampling procedure will recover the underlying distribution.
#' 
#' 
#' 
#' Why MH converge? 
