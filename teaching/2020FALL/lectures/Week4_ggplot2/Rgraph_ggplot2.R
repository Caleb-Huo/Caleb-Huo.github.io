...
##   geom_point() ## if we specify color in aes, it will be regarded as a factor.
## 
## ggplot(data = mpg) +
...
##   geom_point() ## if we specify size in aes, it will be regarded as a factor.
## 
## ggplot(data = mpg) +
...
##   geom_point() ## if we specify alpha in aes, it will be regarded as a factor.
## 
## ggplot(data = mpg) +
...
#' 
#' - wider parts indicate large standard deviation
#' 
#' 
#' ggplot() bar plot 1
#' ===
