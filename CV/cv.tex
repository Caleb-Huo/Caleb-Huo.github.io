...
\emph{Pediatric Nephrology}  (Accepted)



\item  {\bf Zhiguang Huo}, Lei Yu, Jingyun Yang, Yun Zhu,  David A. Bennett, Jinying Zhao. (2019)
Brain and blood metabolome for Alzheimer's dementia: Findings from a targeted metabolomics analysis.
\emph{Neurobiology of aging}  (Accepted)

\item
Ali Zarrinpar,  Ting-Yuan D Cheng, {\bf Zhiguang Huo}. (2019)
...
\emph{Journal of Surgical Research} (Accepted)

\item 
Saunjoo L. Yoon, Oliver Grundmann, Joseph J. Williams, Samuel S. Wu, Christiaan Leeuwenburgh, {\bf Zhiguang Huo}, and Thomas J. George Jr. 
...
\emph{Acupuncture in Medicine} (2019): 0964528419873670.

\item
Kristin Curry Greenwood,  Jennifer Kirwin, {\bf Zhiguang Huo}. (2019)
...
\item Li Zhu, {\bf  Zhiguang Huo}, Tianzhou Ma, George Tseng. (2019)
			Bayesian indicator variable selection to incorporate multi-layer overlapping group structure in multi-omics applications. \emph{Annals of Applied Statistics} (Accepted) (An earlier version won ENAR distinguished student paper award 2018)
