...
\item {\bf Zhiguang Huo}, Yun Zhu, Lei Yu, Jingyun Yang, Philip De Jager, David A. Bennett, Jinying Zhao (2018).
 DNA methylation variability in Alzheimer's Disease. \emph{Neurobiology of Aging} (Accepted).
...
\item Journal of Alzheimer's Disease (1)
\end{itemize}
\end{rSection}
...
\begin{itemize}[noitemsep,topsep=0pt]
    \item Las Olas International Triathlon, Fort Lauderdale, FL. \hfill{03/10/2019, Coming soon!}. 
    \item Five Points of Life Half Marathon, Gainesville, FL. \hfill{02/16/2019, Coming soon!}. 
