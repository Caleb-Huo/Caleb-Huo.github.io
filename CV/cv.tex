...
\item {\bf  Zhiguang Huo*}, Li Zhu, Tianzhou Ma, Li Zhu, Song Han, Daiqing Liao, Jinying Zhao and George Tseng* (2018). 
			Two-way Horizontal and Vertical Omics Integration for Disease Subtype Discovery. (Submitted)
			(*: co-corresponding author).
						
\item Tianzhou Ma*, {\bf  Zhiguang Huo*}, Anche Kuo*, Li Zhu, Fang Zhou, Xiangrui Zeng, Chien-Wei Lin, Silvia Liu, Lin Wang, Tanbin Rahman, Lun-Ching Chang, Sunghwan Kim, Jia Li, Yongseok Park, Chi Song and George C. Tseng. (2018). 
...
\item Marianne Seney,  {\bf Zhiguang Huo},  Kelly Cahill, Leon French, Rachel Puralewski, Joyce Zhang, George Tseng, David A Lewis, Etienne Sibille. (2018) 
Opposite molecular signatures of depression in men and women. \emph{Biological Psychiatry} (Minor revision)
...
\textbf{Main Lecturer (teaching fellow), University of Pittsburgh}
\begin{itemize}[noitemsep,topsep=0pt]
