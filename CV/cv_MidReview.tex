...
\item 
Wolff CA.$^\dagger$, Gutierrez-Monreal, M.A.$^\dagger$, \underline{Meng, L.}, Zhang, X., Douma, L.G, Costello, H.M., Douglas, C.M., Ebrahimi, E., Alava, B.R., Morris, A.R., Endale, M.M., Crislip, G.R., Cheng, K., Schroder, E.A., Delisle, B.P., Bryant, A.J.$^*$, Gumz, M.L.$^*$, {\bf Huo, Z.}$^*$, Liu, A.C.$^*$, and Esser, K.A.$^*$ Defining the age-dependent and tissue-specific circadian transcriptome in male mice. Uploaded to BioRxiv (ID: 489594) 27Apr2022. 
(Submitted to the CELL)
...
(Submitted to the Alzheimer's \& Dementia: The Journal of the Alzheimer's Association)
